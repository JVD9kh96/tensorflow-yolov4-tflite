...
def load_config(FLAGS):
    if FLAGS.tiny:
        ...
        XYSCALE = cfg.YOLO.XYSCALE_TINY if (FLAGS.model == 'yolov4' or FLAGS.model == 'yolov4_vit_v1', FLAGS.model == 'yolov4_vit_v2') else [1, 1]
    else:
        ...
        XYSCALE = cfg.YOLO.XYSCALE if (FLAGS.model == 'yolov4' or FLAGS.model == 'yolov4_vit_v1', FLAGS.model == 'yolov4_vit_v2') else [1, 1, 1]
