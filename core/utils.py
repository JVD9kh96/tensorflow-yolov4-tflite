...
def load_config(FLAGS):
    if FLAGS.tiny:
        ...
        XYSCALE = cfg.YOLO.XYSCALE_TINY if (FLAGS.model == 'yolov4' or FLAGS.model == 'yolov4_vit_v1') else [1, 1]
    else:
        STRIDES = np.array(cfg.YOLO.STRIDES)
        if (FLAGS.model == 'yolov4' or FLAGS.model == 'yolov4_vit_v1'):
            ANCHORS = get_anchors(cfg.YOLO.ANCHORS, FLAGS.tiny)
        elif FLAGS.model == 'yolov3':
            ANCHORS = get_anchors(cfg.YOLO.ANCHORS_V3, FLAGS.tiny)
        XYSCALE = cfg.YOLO.XYSCALE if (FLAGS.model == 'yolov4' or FLAGS.model == 'yolov4_vit_v1') else [1, 1, 1]
