...
__C.YOLO.CLASSES              = "data/classes/alphabet.names"
...
__C.TRAIN.ANNOT_PATH          = "data/dataset/alphabet_train.txt"
...
__C.TRAIN.SECOND_STAGE_EPOCHS   = 120
...
__C.TEST.ANNOT_PATH           = "data/dataset/alphabet_test.txt"
