...
__C.YOLO.CLASSES              = "/content/data/classes/voc.names"
...
__C.TRAIN.ANNOT_PATH          = "/content/data/dataset/voc_train.txt"
__C.TRAIN.BATCH_SIZE          = 2
# __C.TRAIN.INPUT_SIZE            = [320, 352, 384, 416, 448, 480, 512, 544, 576, 608]
__C.TRAIN.INPUT_SIZE          = 416
__C.TRAIN.DATA_AUG            = True
__C.TRAIN.LR_INIT             = 1e-2
...
__C.TEST.ANNOT_PATH           = "/content/data/dataset/voc_test.txt"
