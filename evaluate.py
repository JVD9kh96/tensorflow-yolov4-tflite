...
flags.DEFINE_integer('size', 672, 'resize images to')
flags.DEFINE_string('annotation_path', "../input/data-yolo-train-one-class/Annotations_Test.txt", 'annotation path')
