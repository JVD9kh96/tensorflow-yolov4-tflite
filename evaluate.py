...
def evaluate(arg,
    ...
    feature_maps = YOLO(input_layer, NUM_CLASS, arg.model, arg.tiny, arg.activation)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', help='weights dir')
    parser.add_argument('--model',type=str, default='yolov4_vit_v1', help ='model')
